...
import com.js.joke.controller.FavJokeListAdapter;
...
public class FavJokesFragment extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        mJokeList.clear();
        if (mJokeManager.retrieveJoke().size() > 0) {
            for (Joke joke : mJokeManager.retrieveJoke()) {
                mJokeList.add(joke);
            }
        }
    }
